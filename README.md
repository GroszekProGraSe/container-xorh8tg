...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xorh8tg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xorh8tg.containers.anotherwebservice.com/
...
```
git clone git@github.com:GroszekProGraSe/container-xorh8tg.git
cd container-xorh8tg
```
...
```
docker attach container-xorh8tg
```
